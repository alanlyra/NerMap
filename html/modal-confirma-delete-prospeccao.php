  ...
  <?php 
      ...
      echo "<div class='modal-content'>
              <div class='modal-header'>
                ...
                <h5 class='modal-title' id='exampleModalLabel'>".$LANG['164']."</h5>
              ...
              <form action='seeroadmap.php?".$cabecalho."' method='post' multipart='' enctype='multipart/form-data' style='display: inline-block;'>
                ...
                <button class='btn btn-danger' type='button' onclick='hideModalConfirmaDeleteProspeccao();'>".$LANG['106']."</button>
                <input class='btn btn-primary' type='submit' name='deletarProspeccaoRoadmap' value='".$LANG['107']."' />
                </form>
                </div>
