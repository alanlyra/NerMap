...
?>
  ...
  <?php 
      ...
      echo "<div class='modal-content'>
        ...
        <div class='col-xl-6 col-lg-6 bg-login-image' style='margin-top: -15px; margin-left: -8px;'>
        ...
        <form onSubmit='return validateSubmit()' action='index.php?' method='post' multipart='' enctype='multipart/form-data' style='text-align:center; min-height: 704px;'>
                
        <div class='avatar-upload' style='height: 100px; margin: 0; margin-bottom: 120px; display: inline-block;'>
                    <div class='avatar-edit'>
                        ...
                        <label for='imageUpload'><img src='img/editar7.png' alt='Editar Foto' height='15px' width='15px' style='margin-left:8.5px; margin-top:9px; opacity: 70%;'></label>
                    </div>
  ...
  <script>
    ...
    var typingTimerConfirmaSenhaUsuario;                //timer identifier
