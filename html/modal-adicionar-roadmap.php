  ...
  <?php 
      ...
      echo "<div class='modal-content'>
        ...
        echo "<form action='seeroadmap.php?".$cabecalho."=".$param."' method='post' multipart='' enctype='multipart/form-data'>
                  ...
                  <h5>Ano:</h5>
                    <input type='text' id='anoProspec' name='anoProspec' value='' class='form-control bg-light border-0 small' aria-label='Search' aria-describedby='basic-addon2' onkeyup='this.value=this.value.replace(/[^\d]/,'')'>
                  </div>
                  </br>
                  <div class='col-xl-9 col-lg-10s'>
                   <h5>Prospecção:</h5>
                    <input type='text' id='infoProspec' name='infoProspec' value='' class='form-control bg-light border-0 small' aria-label='Search' aria-describedby='basic-addon2'>
                  </div>
                 </br>
